...
const  DocumentDetailPage = () => {
  const {id} = useParams()
  const[document,setDocment] = useState(null)
...
//   return (
//     <div className='bg-white border border-gray-300 rounded-lg overflow-y-hidden shadow-sm'>
...
const renderContent = () => {
 ...
 return (
  <div>
  <div className='mb-4'>
    <Link to="/documents" className='inline-flex items-center gap-2 text-sm text-neutral-600 hover:text-neutral-900 transitions-colors'>
    <ArrowLeft size={16} />
    Back to Documents
    </Link>
  </div>
  {/* <PageHeader title={document.data.title}/> */}
  <PageHeader title={document?.data?.title || document?.title}/>
