export const BASE_URL = "https://ai-power-learner-backend2-4.onrender.com"
...
export const API_PATHS = {
    AUTH: {
        ...
        CHANGE_PASSWOPD:"/api/auth/change-password",
    },
    ...
    QUIZZES:{
        GENERATE_QUIZZES_FOR_DOC:(documentId) => `/api/quizzes/${documentId}`,
        GENERATE_QUIZ_BY_ID:(id) => `/api/quizzes/quiz/${id}`,
